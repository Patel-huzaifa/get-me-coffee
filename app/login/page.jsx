        ...
        <div className="social-login-button">
          <div className="flex flex-col gap-2 min-h-screen items-center   p-10">
            ...
            <button
              ...
              className="flex items-center w-[550px] cursor-pointer  bg-slate-50 text-black border border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
            >
              <svg
                className="h-6 w-6 mr-2"
                xmlns="http://www.w3.org/2000/svg"
